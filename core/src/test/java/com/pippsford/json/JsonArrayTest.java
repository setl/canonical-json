...
public class JsonArrayTest extends JsonArray {
  ...
  public void testFixCollection() {
    ...
    assertSame(ja, JsonArray.fixCollection(ja));
    ja.add("abc");
    ja.add(123);
    ja.addNull();
    ja.add(true);
    assertEquals(ja, JsonArray.fixCollection(Arrays.asList("abc", 123, null, true)));
  }
  ...
  public void testFixPrimitveCollection() {
    ...
    ja.addNull();
    ja.add(123);
    assertEquals(ja, JsonArray.fixPrimitiveCollection(Arrays.asList(Primitive.TRUE, null, Primitive.create(123))));
  }
