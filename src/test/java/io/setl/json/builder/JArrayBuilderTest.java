 ...
 */
public class JArrayBuilderTest {
  ...
  @Test
  public void addAll() {
    JsonArrayBuilder b = new JArrayBuilder();
    b.add("B").add(2);
    builder.addAll(b);
  ...
  public void testAdd17() {
    JsonObjectBuilder b = new JObjectBuilder();
    b.add("B", 2);
  ...
  public void testAdd7() {
    JsonArrayBuilder b2 = new JArrayBuilder();
    b2.add(1);
    builder.add(b2);
  ...
  public void testAdd8() {
    JsonObjectBuilder b2 = new JObjectBuilder();
    b2.add("A", 1);
    builder.add(b2);
