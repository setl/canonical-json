...
public class JStructureParserTest {
  ...
  public void getArrayStream2() {
    JsonArray array = new JArrayBuilder()
        .add(new JObjectBuilder().add("a", 1))
        .add(true)
        .build();
    JsonParser parser = new JParserFactory(null).createParser(array);
    assertEquals(Event.START_ARRAY, parser.next());
  ...
  public void getArrayStream3() {
    JsonArray array = new JArrayBuilder()
        .add(new JArrayBuilder().add(1).add("a").add(false).add(4))
        .add(true)
        .build();
    JsonParser parser = new JParserFactory(null).createParser(array);
    assertEquals(Event.START_ARRAY, parser.next());
  ...
  public void getBigDecimal1() {
    JsonArray array = new JArrayBuilder().add(4.3).build();
    JsonParser parser = new JParserFactory(null).createParser(array);
    parser.next();
  ...
  public void getBigDecimal2() {
    JsonObject object = new JObjectBuilder().add("a", 4.3).build();
    JsonParser parser = new JParserFactory(null).createParser(object);
    parser.next();
    parser.next();
    assertEquals(Event.VALUE_NUMBER, parser.next());
    BigDecimal bd = parser.getBigDecimal();
  ...
  public void getObject() {
    JsonObject value = new JObjectBuilder().add("b", 4.3).build();
    JsonObject object = new JObjectBuilder().add("a", value).add("c", true).build();
    JsonParser parser = new JParserFactory(null).createParser(object);
    parser.next();
    parser.next();
    assertEquals(Event.START_OBJECT, parser.next());
  ...
  public void getObject1() {
    JsonObject value = new JObjectBuilder().add("b", 4.3).build();
    JsonArray array = new JArrayBuilder().add(value).add(true).build();
    JsonParser parser = new JParserFactory(null).createParser(array);
    parser.next();
    assertEquals(Event.START_OBJECT, parser.next());
    JsonObject o = parser.getObject();
  ...
  public void getObjectStream1() {
    JsonArray array = new JArrayBuilder()
        .add(new JObjectBuilder().add("a", 1).add("b", 2).add("c", 3))
        .add(true)
        .build();
    JsonParser parser = new JParserFactory(null).createParser(array);
    assertEquals(Event.START_ARRAY, parser.next());
  ...
  public void getObjectStream2() {
    JsonArray array = new JArrayBuilder()
        .add(new JObjectBuilder().add("a", 1).add("b", "b").add("c", false).add("d", 4))
        .add(true)
        .build();
    JsonParser parser = new JParserFactory(null).createParser(array);
    assertEquals(Event.START_ARRAY, parser.next());
  ...
  public void getValueStream() {
    JsonObject object = new JObjectBuilder().add("a", "b").build();
    JsonParser parser = new JParserFactory(null).createParser(object);
    parser.next();
  ...
  public void testIntegral() {
    JsonArray array = new JArrayBuilder().add(1).add(2.0).add("3").add(2.3).build();
    JsonParser parser = new JParserFactory(null).createParser(array);
    parser.next();
    parser.next();
